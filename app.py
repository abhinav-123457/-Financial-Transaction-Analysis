...
@st.cache_data
def calculate_balances(transactions, target_date_str='15-08-2025 16:24:00 IST'):
    if not transactions:
        return [], [], 0, 0, 0, 0, 0, 0
...
def main():
    ...
    st.markdown("Upload a CSV or Excel file to calculate overdue amounts with **18% per day interest**. View results, a pie chart, and download an Excel report. *Last updated: 04:24 PM IST, August 15, 2025*")
